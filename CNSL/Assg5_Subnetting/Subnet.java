...
Enter the ip address: 201.70.64.0
Class C IP Address
Defaultt mask is: 255.255.255.0
IP in binary is 11001001010001100100000000000000
Enter the number of subnets: 8
Number of bits borrowd from host to network are = 3
Number of host bits are = 5
New subnet mask is = 224
Subnet Size = 32first Subnet Details
first N/W address is = 201.70.64.0
Broadcast address is = 201.70.64.31
